...
import 'package:read_track/features/title_detail/presentation/widgets/detail_header.dart';
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          DetailHeader(
            title: widget.title,
            onAddToLibrary: _openAddToLibrary,
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return GestureDetector(
                          onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => TitleDetailScreen(title: t),
                            ),
                          ),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
